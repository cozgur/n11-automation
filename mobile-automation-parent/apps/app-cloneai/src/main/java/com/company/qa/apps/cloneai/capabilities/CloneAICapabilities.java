...
/**
 * Capability factory for the CloneAI mobile application.
 * Reads device defaults from apps.json, allowing override via system properties.
 */
public class CloneAICapabilities {

    private static final String APP_KEY = "cloneai";

    /**
     * Creates Android capabilities for CloneAI.
    ...
    /**
     * Creates iOS capabilities for CloneAI.
     * Device and version defaults come from apps.json.
     *
